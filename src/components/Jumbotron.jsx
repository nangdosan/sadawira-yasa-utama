...
export default function Jumbotron() {
  return (
    <section id="#" className="relative h-[600px] md:h-[662px] mt-7 md:mt-0">
      ...
      <div className="absolute top-0 left-0 h-full flex flex-col justify-center items-start px-7 md:px-24 z-10 w-full md:w-6/12 lg:7/12">
        ...
        <p className="mb-5">
          Jasa Custom Clearance Ekspor Impor dan Ekspedisi general cargo Door to
          Door di Indonesia, dengan layanan cepat dan terpercaya.
        </p>
        <SocialMedia />
        <Link
          href="#tentang-kami"
